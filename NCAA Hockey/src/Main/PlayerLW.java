...
/**
 * Class for the Left Wing (LW) player in hockey,
 * adapted from the original PlayerRB structure.
 */
public class PlayerLW extends PlayerHockey {

    // Core LW skill attributes
    ...
    /**
     * Primary constructor for PlayerLW.
     */
    public PlayerLW(String nm, TeamHockey tm, int yr, int pot, int iq,
    ...
    /**
     * Constructor including career stats.
     */
    public PlayerLW(String nm, TeamHockey tm, int yr, int pot, int iq,
                    int shotPow, int spd, int pc, boolean rs, int dur,
    ...
    /**
     * “Recruit” style constructor (stars-based).
     */
    public PlayerLW(String nm, int yr, int stars, TeamHockey tm) {
        name = nm;
        year = yr;
        team = tm;
        gamesPlayed = 0;
    ...
    /**
     * Refresh rating vector for UI display.
     */
    ...
    public int getHeismanScore() {
        // Weighted formula for “Hobey Baker” type awarding:
